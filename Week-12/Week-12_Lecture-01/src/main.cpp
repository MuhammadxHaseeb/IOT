...
#define BLYNK_TEMPLATE_ID "TMPL6j6D5gdRX"
#define BLYNK_TEMPLATE_NAME "Week 12"
#define BLYNK_AUTH_TOKEN "P8PrgGmWZ-0SRMzc1wBxEFGU0L3keKpS"
...
#define BUTTON_PIN 25   // pushbutton, one side to GPIO5, other to GND
